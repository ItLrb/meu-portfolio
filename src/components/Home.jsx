            ...
            <main id="home" className="flex justify-center items-center w-screen h-screen">
                <div className="text-white">
                    ...
                    <div className="buttons inline-flex items-center mt-5">
                        ...
                        <Tooltip content="LinkedIn" placement="bottom" style="light"> 
                                <li id="linkedin" className="border-[3px] border-[#1649FD] hover:bg-[#0a3e6bb2] transition-all rounded-[15px] px-[3px] py-[3px]">   
                                        <a href="https://www.linkedin.com/in/italo-roberto-a4921b278/" target="_blank">
